                ...
                if (data) {
                    ...
                    $.each(data, function (index, value) {
                        ...
                        if ($.isPlainObject(value)) {
                            ...
                            var hrefValue = settings.link.replace("%s", value);
                            str.push('<li ' + vclass + ' data-icon=' + settings.icon + '><a href="javascript:void(0)" onclick="' + hrefValue + '" data-transition="' + settings.transition + '">' + settings.labelHTML(value) + '</a></li>');
                        }
                    });
                }
            }
